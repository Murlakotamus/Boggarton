...
public class CompetitionGame extends AbstractMultiplayerScene {
    ...
    public CompetitionGame(final int width, final int height, final int[] forecast, final int figureSize, final YuckTypes yuckType, final RandomTypes randomType,
            final DifficultyTypes difficulty) {

        super(SceneItem.COMPETITION_PRACTICE, width, height, forecast, figureSize, 2, yuckType, randomType, difficulty);
