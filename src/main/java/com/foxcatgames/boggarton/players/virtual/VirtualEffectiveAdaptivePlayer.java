...
public class VirtualEffectiveAdaptivePlayer<B extends Brick, F extends AbstractFigure<B>, G extends AbstractGlass<B, F>, P extends AbstractForecast<B, F>, T extends IAutomatedGame<B, F, G, P>>
        extends AbstractVirtualAdaptivePlayer<B, F, G, P, T> {

    public VirtualEffectiveAdaptivePlayer(final T game, final int prognosis, final IEater price) {
